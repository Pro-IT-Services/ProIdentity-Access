...
function ThroughputCell({
  icon, label, data, total, color,
}: { icon: React.ReactNode; label: string; data: number[]; total: number; color: string }) {
  return (
    <div className="text-center">
      ...
      <p className="text-xl font-semibold tabular-nums" style={{ color }}>{formatBytes(total)}</p>
