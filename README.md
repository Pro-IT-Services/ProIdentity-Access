...
sudo sh install-release.sh Pro-IT-Services/ProIdentity-Access 0.5.21
```

The installer downloads and verifies these release assets:

```text
ProIdentity-Access-Server-0.5.21-linux-amd64.tar.gz
ProIdentity-Access-0.5.21-SHA256SUMS.txt
```
